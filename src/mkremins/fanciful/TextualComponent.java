...
public abstract class TextualComponent implements Cloneable {
	...
	/**
	 * Create a textual component representing a net.veilmc.practice.scoreboard value.
	 ...
	 * @return The text component representing the specified net.veilmc.practice.scoreboard score (for the viewing player), or {@code null} if an error occurs during JSON serialization.
	 */
	 ...
	 * @param scoreboardObjective The name of the objective for which to display the score.
	 * @return The text component representing the specified net.veilmc.practice.scoreboard score for the specified player, or {@code null} if an error occurs during JSON serialization.
	 */
